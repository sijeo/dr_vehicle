...
__used __section(__versions) = {
	...
	{ 0xd6dc4316, "__pm_runtime_disable" },
	{ 0x6091b333, "unregister_chrdev_region" },
	{ 0xc7885d0b, "cdev_del" },
	{ 0x26d1dbff, "class_destroy" },
	{ 0x2a0c0a51, "device_destroy" },
	{ 0xb8855baa, "_dev_err" },
	{ 0xff64c5f1, "__pm_runtime_idle" },
	...
	{ 0xaff70bc5, "__pm_runtime_set_status" },
	{ 0x8529c94b, "pm_runtime_enable" },
...
MODULE_INFO(srcversion, "91830198572D8EA350C573E");
